...
st.markdown("""
    <style>
    /* 1. ตั้งค่าฟอนต์ Kanit ให้ทั้งแอป */
    @import url('https://fonts.googleapis.com/css2?family=Kanit:wght@400;700&display=swap');
    html, body, [class*="css"], .stMarkdown, h1, h2, h3, p, span {
        font-family: 'Kanit', sans-serif !important;
    }

    /* 2. สไตล์พื้นฐานของทุกปุ่ม (เงาบางๆ มุมโค้ง) */
    div.stButton > button {
        width: 100%;
        height: 100px;
        border-radius: 20px;
    ...
    /* 3. บังคับสีแยกตามประเภท (ใช้ลำดับปุ่มในหน้าแรก) */
    
    /* ปุ่มที่ 1: บันทึกข้อความ -> สีฟ้าพาสเทล */
    div[data-testid="stVerticalBlock"] > div:nth-child(8) div.stButton > button {
        background-color: #E0F2FE !important;
    }

    /* ปุ่มที่ 2: เลขคำสั่ง -> สีเขียวพาสเทล */
    div[data-testid="stVerticalBlock"] > div:nth-child(9) div.stButton > button {
        background-color: #DCFCE7 !important;
    }

    /* ปุ่มที่ 3: เลขหนังสือส่ง -> สีส้มพาสเทล */
    div[data-testid="stVerticalBlock"] > div:nth-child(10) div.stButton > button {
    ...
    div.stButton > button:hover {
        ...
        filter: brightness(0.95); /* ทำให้สีเข้มขึ้นนิดนึงเวลาชี้ */
    }
    </style>
