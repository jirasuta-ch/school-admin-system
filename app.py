...
st.markdown("""
    ...
    /* 2. สไตล์พื้นฐานของปุ่ม (เงาบางๆ มุมโค้ง) */
    div.stButton > button {
        width: 100%;
        height: 90px;
        border-radius: 18px;
        ...
        color: #374151; /* สีตัวอักษรเทาเข้ม ดูซอฟต์กว่าสีดำ */
    }

    /* 3. กำหนดสีพาสเทลแยกตามลำดับปุ่ม */
    ...
    /* ปุ่มที่ 3: เลขหนังสือส่ง (สีส้ม/เหลืองพาสเทล) */
