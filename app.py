...
st.markdown("""
    ...
    div.stButton > button {
        ...
        color: #1E3A8A;
        font-family: 'Kanit', sans-serif !important; /* ใช้ฟอนต์ Kanit ในปุ่ม */
    ...
    /* เอฟเฟกต์เวลา Hover (ให้สีดูละมุนขึ้น) */
